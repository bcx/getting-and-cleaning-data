...
# Read in the lookup date for the activies.  This lookup table
...
# The activity codes for out 7352 observations.
y_train <- read.table("train/y_train.txt")

# The subject numbers (IDs) for out 7352 observations.
...
# The 2947 observations of 561 variables.
X_test <- read.table("test/X_test.txt")   

# The activity codes for out 2947 observations.
y_test <- read.table("test/y_test.txt")

# The subject numbers (IDs) for out 2947 observations.
...
# Label the subject columns and activity_codes.
...
# each observation.  This is out second tidy data set.
# =======================================
